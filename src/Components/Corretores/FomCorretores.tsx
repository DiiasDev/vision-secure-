...
import { secoesCorretores } from './FieldsCorretores';
...
export default function FormCorretores() {
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        if (dataNascimento) {
            formObject.dataNascimento = dataNascimento.format('YYYY-MM-DD');
        }
        
        console.log('Dados do Corretor:', formObject);
                ...
                <div className="w-full max-w-7xl mx-auto p-8">
                    <div className="bg-[var(--bg-card)] rounded-2xl p-8 shadow-[var(--shadow-md)] border border-[var(--border-default)]">
                        ...
                        <p className="text-base text-[var(--text-secondary)] mb-8 leading-relaxed">
                            Preencha os dados do corretor para cadastro no sistema
                        </p>
                        
                        <form onSubmit={handleSubmit} className="space-y-8">
                            {secoesCorretores.map((secao, index) => (
